    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: `
            ...
            ` }), _jsxs("div", { className: `MPCS ${MCS ? 'ALCS' : ''}`, style: {
                    ...
                    zIndex: '4'
                        ...
                        } }), ['Reportes', 'Historial'].map((text, index) => (_jsxs("button", { style: {
                            ...
                            padding: '15px', cursor: 'pointer'
                                ...
                                } }), _jsx("b", { children: text })] }, text)))] }), Reportes && (_jsx(TablaInstructor, {})), ";", Historiall && (_jsx(TablaHistorial, {})), ";", showSearchIcon && (_jsxs("div", { className: 'Lateral', style: {
