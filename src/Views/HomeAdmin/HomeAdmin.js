...
import Peti from './icon_Home_Admin/Peticiones.svg';
import Reporte from './icon_Home_Admin/Reporte.svg';
import { useState, useEffect } from 'react';
import Tabla_Usuarios_SU from '../Tablas/Tabla_Usuarios_SU';
import Tabla_Peticiones_Ingreso from '../Tablas/Tabla_Peticiones_ingreo';
import Tabla_Reportes_SU from '../Tablas/Tabla_Reportes_SU';
import { Cerrar_Sesion } from '../../Components/Botones/Botones';
import Tabla_Equipos_SU from '../Tablas/Tabla_Equipos_SU';
export default function HomeAdmin() {
    ...
    //--------------------------------------------------------------------------------------------
    // Modal de tabla de peticiones de ingreso a la plataforma
    const [Peticiones, setPeticiones] = useState(false);
    const AbrirPeticiones = () => {
        setPeticiones(!Peticiones);
    };
    const CerrarPeticiones = () => {
        setPeticiones(false);
    };
    //--------------------------------------------------------------------------------------------
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: `
            ...
            ` }), _jsxs("div", { className: `MPCS ${MCS ? 'ALCS' : ''}`, style: {
                    ...
                    zIndex: '4'
                        ...
                        }, children: correo }), _jsx("a", { href: "/", children: _jsx(Cerrar_Sesion, {}) }), _jsx("p", { style: { margin: '0', fontSize: '11px', cursor: 'pointer' }, onClick: AMCS, children: "cancelar" })] }), _jsxs("div", { className: `AMCL ${MCL ? 'ALCL' : ''}`, children: [_jsx("img", { src: Cerrar, onClick: CMCL, style: {
                            width: '40px',
                            cursor: 'pointer'
                        } }), _jsx("img", { src: Logo, style: {
                            width: '110px', margin: '10px auto'
                        } }), ['Usuarios', 'Equipos', 'Reportes', 'Peticiones'].map((text, index) => (_jsxs("button", { style: {
                            ...
                            padding: '15px', cursor: 'pointer'
                                ...
                                } }), _jsx("b", { children: text })] }, text)))] }), Equipos_Pc && (_jsx(Tabla_Equipos_SU, {})), ";", Usuarios && (_jsx(Tabla_Usuarios_SU, {})), Reportes_SU && (_jsx(Tabla_Reportes_SU, {})), Peticiones && (_jsx(Tabla_Peticiones_Ingreso, {})), showSearchIcon && (_jsxs("div", { className: 'Lateral', style: {
                    width: '200px', height: '100%', position: 'fixed', zIndex: '4',
                    background: 'white',
