...
export default function Anuncios() {
    ...
    return (_jsxs(_Fragment, { children: [showAlert_inicio && (_jsx("div", { style: { position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', color: 'white', background: 'linear-gradient(145deg, #232323, #1e1e1e)', padding: '20px', borderRadius: '10px', zIndex: '9999', }, children: "Equipo no encontrado, vuelva a intentar." })), _jsx("body", { style: { display: 'flex', justifyContent: 'center', alignItems: 'center' }, children: _jsxs("table", { style: {
                    ...
                    }, children: [_jsx("div", { style: { marginLeft: '85px' }, children: _jsx("h1", { style: { color: '#096ECB' }, children: "Crear anuncios" }) }), _jsxs("div", { style: { marginTop: '30px', marginLeft: '133px', display: 'flex', flexDirection: 'row' }, children: [_jsxs("div", { style: { textAlign: 'start', justifyContent: 'start' }, children: [_jsx("p", { children: "Descripcion" }), _jsx("input", { type: "text", className: 'descripcion', id: 'descripcion', style: {
                                                width: '800px', height: '350px', padding: '9px', border: 'none',
                                                background: '#F5F7FA', borderRadius: '20px', outline: 'none',
                                                paddingLeft: '30px'
                                            } })] }), _jsxs("div", { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', marginLeft: '50px' }, children: [_jsx("select", { value: selectedOption ? selectedOption.id : '', onChange: handleChange, style: {
                                                width: '200px',
                                                padding: '10px',
                                                borderRadius: '5px',
                                                border: '1px solid #ccc',
                                                marginBottom: '20px'
                                            }, children: options.map(option => (_jsx("option", { value: option.id, children: option.descripcion }, option.id))) }), selectedOption && (_jsxs("div", { style: { textAlign: 'center' }, children: [_jsx("img", { src: selectedOption.urlImagen, alt: selectedOption.descripcion, style: { width: '400px', height: '400px', objectFit: 'cover' } }), _jsx("p", { children: selectedOption.descripcion })] }))] })] }), _jsxs("div", { style: { display: 'flex', flexDirection: 'row-reverse', marginLeft: '600px', marginTop: '50px' }, children: [_jsx("button", { onClick: handleSubmit, style: {
