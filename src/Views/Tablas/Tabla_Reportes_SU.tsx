                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <thead>
                        <tr style={{ height: '60px', }}>
                            ...
                            <th style={{ padding: '10px', minWidth: '100px' }}>Remitente</th>
                            <th style={{ padding: '10px', minWidth: '200px' }}>Nombre del encargado</th>
                            <th style={{ padding: '10px', minWidth: '150px' }}>Cargo del encargado</th>
                    ...
                    <tbody>
                        ...
                        {usuariosFiltrados.length === 0 ? (
                            ...
                            usuariosFiltrados.map((item, index) => {
                                ...
                                return (
                                    <tr key={index} style={{ height: '60px', borderTop: 'solid 2px #f0f0f0', textAlign: 'center' }}>
